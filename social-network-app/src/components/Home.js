...
export default function Home({ usersArray }) {
   // const [isLoged, setIsLoged] = useState(localStorage.getItem('isLoged'));
    ...
    return (
        ...
        <div>
              {localStorage.getItem('isLoged') !==null&&localStorage.getItem('isLoged')!=='null' ?   <> <button onClick={() => { console.log(localStorage.getItem('isLoged'));console.log(user.isLoged); }}>DUGME</button>
